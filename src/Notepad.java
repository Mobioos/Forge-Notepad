...
public class Notepad extends JFrame {
    ...
    private JMenuItem neW, opeN, savE, saveAS, prinT, exiT, fonT, abouT,
            cuT, copY, pastE, selectALL, refresH;
    ...
    public void buildUI() {
        ...
        filE.add(exiT = new JMenuItem("Exit")); // , new ImageIcon(this.getClass().getResource("images/exit.gif")))); --
                                                // exit.gif missing
        filE.insertSeparator(4);
        filE.insertSeparator(6);

        /**
         * adding undO, redO, cuT, copY, pastE, finD, findNexT & selectALL to the ediT
         * Menu,
         * adding a small image icon to the menu item &
         * adding separator between the menu item
         */
        ...
        helP.add(
                abouT = new JMenuItem("About Notepad", new ImageIcon(this.getClass().getResource("images/about.gif"))));

        // Add the refresh button
        vieW.add(refresH = new JMenuItem("Refresh"));
        refresH.addActionListener(ae -> this.buildUI());
         ...
         * undoButton,
         * redoButton, cutButton, copyButton, pasteButton, fontButton & aboutButton to
         * the tool bar,
         * adding a small image icon to the menu item &
         ...
         * redO, undO, copY, cuT, pastE, finD, findNexT, selectALL, lineWraP, fonT &
         * abouT
         * the actions was written @Actions.java
         */
        neW.addActionListener((ae) -> actions.neW());
        opeN.addActionListener((ae) -> actions.opeN());
        savE.addActionListener((ae) -> actions.savE());
        saveAS.addActionListener((ae) -> actions.saveAs());
        prinT.addActionListener((ae) -> actions.prinT());
        exiT.addActionListener((ae) -> actions.exiT());
        selectALL.addActionListener((ae) -> actions.selectALL());
        lineWraP.addActionListener((ae) -> actions.lineWraP());
        fonT.addActionListener((ae) -> actions.fonT());
        abouT.addActionListener((ae) -> actions.abouT());
         ...
         * cutButton, pasteButton, findButton, selectALL, lineWraP, fontButton &
         * aboutButton
         * the actions was written @Actions.java
         */
        newButton.addActionListener((ae) -> actions.neW());
        openButton.addActionListener((ae) -> actions.opeN());
        saveButton.addActionListener((ae) -> actions.savE());
        saveAsButton.addActionListener((ae) -> actions.saveAs());
        printButton.addActionListener((ae) -> actions.prinT());
        fontButton.addActionListener((ae) -> actions.fonT());
        aboutButton.addActionListener((ae) -> actions.abouT());
        ...
        cuT.addActionListener((ae) -> actions.cuT());
        copY.addActionListener((ae) -> actions.copY());
        pastE.addActionListener((ae) -> actions.pastE());

        cutButton.addActionListener((ae) -> actions.cuT());
        copyButton.addActionListener((ae) -> actions.copY());
        pasteButton.addActionListener((ae) -> actions.pastE());
        ...
        finD.addActionListener((ae) -> actions.finD());
        findNexT.addActionListener((ae) -> actions.findNexT());

        findButton.addActionListener((ae) -> actions.finD());
