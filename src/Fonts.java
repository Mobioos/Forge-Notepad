...
public class Fonts extends JDialog {
    ...
    public Fonts() {
         ...
         */
        center.fCenter();
        // add action listener to Font JComboBox to get the selected item for setting
        // the preview
        fjcb.addActionListener(
                (ae) -> jl.setFont(new Font(String.valueOf(fjcb.getSelectedItem()), tjcb.getSelectedIndex(), 14)));
        // add action listener to Type JComboBox to get the selected index for setting
        // the preview
        tjcb.addActionListener(
                (ae) -> jl.setFont(new Font(String.valueOf(fjcb.getSelectedItem()), tjcb.getSelectedIndex(), 14)));
    }
