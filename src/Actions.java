...
public class Actions {
	...
	/**
	 * If we want to write a new text, first we want to know if the text area is
	 * empty or not,
	 * second we want to know if the text was saved or not.
	 * If the text area isn't empty & the text wasn't saved before this time, then
	 * the program display ->
	...
	public void fonT() {
		...
		font.getOkjb().addActionListener((ae) -> {
		...
		font.getCajb().addActionListener((ae) -> {
	...
	public void finD() {
		try {
			...
			// if the JTextField in the input dialog is empty (null), then return a message
			// dialog
